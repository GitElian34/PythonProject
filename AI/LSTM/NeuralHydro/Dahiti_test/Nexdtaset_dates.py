...
# PARAMÈTRES
# ═══════════════════════════════════════════════════════════════
CSV     = "./data/outlier_detection/residuals_27j_dahiti_clean.csv"
NC_DIR  = "./data/IA/NeuralHydrologyDahiti27jClean/27j/time_series"
OUTPUT  = "./AI/LSTM/NeuralHydro/Dahiti_test/Nexdtaset_dates.csv"
